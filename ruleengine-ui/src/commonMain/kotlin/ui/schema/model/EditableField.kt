 ...
 * The bridge layer (jvmMain) converts between this model and [ruleengine.core.domain.dto.field.FieldSchema].
 */
data class EditableField(
     ...
     *
     * Recursive, mirroring [ruleengine.core.domain.dto.field.FieldDefinition.fields], so a collection of objects
